...
const dangerousPatterns = [
  ...
  // Split the JWT prefix to avoid matching the CI's own secret scanner regex
  { pattern: new RegExp('ey' + 'JhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9\\.[a-zA-Z0-9._-]{50,}'), label: 'Hardcoded JWT' },
];
