...
if (!TOKEN) {
  console.warn('⚠️ WARNING: SUPABASE_ACCESS_TOKEN not set. Skipping RLS coverage audit.');
  console.warn('This usually happens on PRs from forks where secrets are restricted.');
  process.exit(0);
}
