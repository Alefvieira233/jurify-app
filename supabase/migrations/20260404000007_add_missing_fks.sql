...
-- ============================================
CREATE INDEX IF NOT EXISTS idx_assistant_audit_tenant_id ON public.assistant_audit(tenant_id);
CREATE INDEX IF NOT EXISTS idx_assistant_audit_user_id ON public.assistant_audit(user_id);
CREATE INDEX IF NOT EXISTS idx_assistant_conversations_tenant_id ON public.assistant_conversations(tenant_id);
CREATE INDEX IF NOT EXISTS idx_assistant_conversations_user_id ON public.assistant_conversations(user_id);
CREATE INDEX IF NOT EXISTS idx_integracoes_externas_tenant_id ON public.integracoes_externas(tenant_id);
CREATE INDEX IF NOT EXISTS idx_document_hashes_tenant_id ON public.document_hashes(tenant_id);
CREATE INDEX IF NOT EXISTS idx_google_calendar_settings_user_id ON public.google_calendar_settings(user_id);
CREATE INDEX IF NOT EXISTS idx_google_calendar_sync_log_user_id ON public.google_calendar_sync_log(user_id);
CREATE INDEX IF NOT EXISTS idx_logs_execucao_agentes_agente_id ON public.logs_execucao_agentes(agente_id);
CREATE INDEX IF NOT EXISTS idx_logs_execucao_agentes_tenant_id ON public.logs_execucao_agentes(tenant_id);
