 ...
 * - PII content filtering (CPF, RG, phone, email, CNPJ, OAB, CNJ)
...
export function sanitizeInput(
  ...
  // Threshold reduced to 16 characters to catch shorter payloads.
 ...
 * Redacts PII from query and error fields before persistence.
 */
