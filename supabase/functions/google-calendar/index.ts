...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.error("[google-calendar] Error:", message, stack);

    // Secure error response: return generic message to client to avoid leaking
    // internal implementation details or stack traces, while logging raw error internally.
