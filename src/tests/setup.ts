...
vi.mock("@capacitor/camera", () => ({
  Camera: {
    getPhoto: vi
      .fn()
      .mockResolvedValue({ webPath: "blob:test-image", format: "jpeg" }),
...
vi.mock("@capacitor/share", () => ({
  Share: {
    share: vi
      .fn()
      .mockResolvedValue({ activityType: "com.apple.UIKit.activity.Message" }),
...
vi.mock("@aparajita/capacitor-biometric-auth", () => ({
  BiometricAuth: {
    ...
    checkBiometry: vi
      .fn()
      .mockResolvedValue({ isAvailable: true, biometryType: 2 }),
  },
}));
