...
describe("formatarAreaJuridica", () => {
  ...
  it("formats unknown legal areas using fallback logic", () => {
...
describe("formatarEtapaPipeline", () => {
  ...
  it("formats unknown pipeline stages using fallback logic", () => {
    expect(formatarEtapaPipeline("etapa_custom_99")).toBe("Etapa Custom 99");
  });
});
