...
test.describe('Jurify — Autenticação', () => {
  ...
  test('deve alternar para tela de cadastro e exibir validação de senha', async ({ page }) => {
    ...
    // Type a weak password and check strength indicator (using strict exact matching to avoid matching Confirmar Senha)
  ...
  test('deve bloquear cadastro com senha fraca', async ({ page }) => {
    ...
    // Using strict exact matching to avoid matching Confirmar Senha
